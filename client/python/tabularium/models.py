...
#   filename:  api.yaml
#   timestamp: 2025-09-25T20:21:09+00:00
...
class Message(BaseModel):
    ...
    messageId: Annotated[
        ...
        Field(
            ...
            examples=['1sB5tZfLipTVWQWHVKnDFS6kFRK'],
        ),
    ]
    role: Annotated[
        str,
...
class Metadata(BaseModel):
    ...
    origins: Annotated[
        Optional[List[str]],
        Field(
            description='List of originating asset classes for this entity',
            examples=['["amazon", "ipv4"]'],
        ),
    ] = None
    province: Annotated[
        Optional[str],
