...
#   filename:  api.yaml
#   timestamp: 2026-01-30T04:24:35+00:00
...
class Account(BaseModel):
    ...
    allowed_domains: Annotated[
        list[str] | None,
        Field(
            description='Domains allowed for this tenant (in addition to inherited).',
            examples=['["subsidiary.com"]'],
        ),
    ] = None
    inherited_domains: Annotated[
        list[str] | None,
        Field(
            description='Domains inherited from parent tenant.',
            examples=['["example.com", "acme.com"]'],
        ),
    ] = None
    key: Annotated[
        str,
    ...
    parent_tenant: Annotated[
        str | None,
        Field(
            description='Email of the parent tenant if this is a child tenant.',
    ...
    shared_from_parent: Annotated[
        bool | None,
        Field(
            description='True if this user account was shared from a parent tenant.',
            examples=['true'],
        ),
    ] = None
    tenant_type: Annotated[
        str | None,
        Field(
            description="Tenant type: 'parent', 'child', or 'standalone'.",
            examples=['child'],
        ),
    ] = None
    ttl: Annotated[
