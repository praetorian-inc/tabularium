...
#   filename:  api.yaml
#   timestamp: 2026-02-26T15:42:05+00:00
...
class Agoraparameter(BaseModel):
    ...
    options: Annotated[
        list[str] | None,
        Field(
            description='Suggested choices for enum-style parameters, used as UI hints',
            examples=['["option_a","option_b"]'],
        ),
    ] = None
    required: Annotated[
        bool, Field(description='Whether the parameter is required', examples=['true'])
...
class Conversation(BaseModel):
    ...
    trace_id: Annotated[
        str | None,
        Field(
            description='Trace ID for correlating telemetry events across conversation.'
        ),
    ] = None
    user: Annotated[
        str,
...
class Event(BaseModel):
    ...
    attributes: Annotated[
        dict[str, Any] | None, Field(description='Additional attributes.')
    ] = None
    created: Annotated[
        str, Field(description='Prefixed timestamp for Created GSI queries.')
    ]
    event_id: Annotated[str, Field(description='Unique event identifier (UUID).')]
    event_type: Annotated[
        str, Field(description='Type of event (job_start, job_end, etc).')
    ]
    key: Annotated[str, Field(description='Event key: #event#{trace_id}#{event_id}')]
    parent_span_id: Annotated[str | None, Field(description='Parent span ID.')] = None
    span_id: Annotated[str, Field(description="This span's identifier (UUID).")]
    trace_id: Annotated[str, Field(description='Root trace identifier (UUID).')]
    username: Annotated[str, Field(description='Account owner for tenant isolation.')]
...
class Job(BaseModel):
    ...
    current_span_id: Annotated[
        str | None,
        Field(
            description='Current execution span ID (not persisted to DynamoDB, but serialized through SQS for trace correlation).'
        ),
    ] = None
    delayed: Annotated[
        str | None,
    ...
    parent_span_id: Annotated[
        str | None, Field(description='Parent span ID from spawning job.')
    ] = None
    partition: Annotated[
        str | None,
        Field(
    ...
    trace_id: Annotated[
        str | None, Field(description='Root trace ID for this job chain.')
    ] = None
    ttl: Annotated[
        int,
        Field(
...
class Ticket(BaseModel):
    ...
    id: Annotated[
        str,
        Field(
            description='Ticket identifier in the external system.',
            examples=['PROJ-123'],
        ),
    ]
    link: Annotated[
        ...
        Field(
            ...
            examples=['https://jira.example.com/browse/PROJ-123'],
        ),
    ] = None
    provider: Annotated[
        str,
        Field(
            description='ITSM provider name (e.g., jira, azuredevops, freshdesk).',
            examples=['jira'],
        ),
    ]
    status: Annotated[
        str | None,
        Field(description='Current status of the ticket.', examples=['In Progress']),
    ] = None
...
class Ticketdata(BaseModel):
    ...
    tickets: Annotated[
        list[dict[str, Any]] | None,
        Field(description='ITSM tickets associated with this risk.'),
    ] = None
...
class Webpage(BaseModel):
    BaseModel: dict[str, Any]
    EndpointFingerprint: dict[str, Any]
    History: dict[str, Any]
    ...
    metadata: Annotated[
        dict[str, Any],
        Field(
            description='Deprecated: Additional metadata associated with the webpage.',
    ...
    resources: Annotated[
        str,
        Field(
            description='Path to network resources zip',
            examples=['webpage/example.com/443/network_resources.zip'],
        ),
    ]
    screenshot: Annotated[
        ...
        Field(
            ...
            examples=['webpage/example.com/443/screenshot.jpeg'],
        ),
    ]
    source: Annotated[
        list[str],
