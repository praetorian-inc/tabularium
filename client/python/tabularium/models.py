...
#   filename:  api.yaml
#   timestamp: 2026-03-13T15:40:44+00:00
...
class IamAwsPermission(BaseModel):
    BaseRelationship: dict[str, Any]
    actions: list[str]
...
class Monitordetection(BaseModel):
    BaseModel: dict[str, Any]
    alert_id: str
    description: str
    detected_at: str
...
class Monitoredtechnique(BaseModel):
    BaseModel: dict[str, Any]
    key: str
    name: str
    technique_id: str
...
class Webapplication(BaseModel):
    ...
    sso_identified: Annotated[
        bool,
        Field(
            description='Whether SSO has been identified and configured for this web application'
        ),
    ]
    urls: Annotated[
        list[str],
    ...
    web_auth_status: Annotated[
        str | None,
        Field(
            description='Status of web auth credential validation (active/failed/validating)'
        ),
    ] = None
