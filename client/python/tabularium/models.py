...
#   filename:  api.yaml
#   timestamp: 2025-12-18T17:32:16+00:00
...
class CapabilitySchedule(BaseModel):
    ...
    endDate: Annotated[
        Optional[str],
        Field(description='Schedule end date in RFC3339 format (optional)'),
    ] = None
    key: Annotated[str, Field(description='DynamoDB partition key')]
    lastExecution: Annotated[
        Optional[str], Field(description='Last execution timestamp')
    ] = None
    nextExecution: Annotated[
        Optional[str], Field(description='Calculated next execution time')
    ] = None
