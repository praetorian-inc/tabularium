...
type Technology struct {
	...
	AliasCPE
	CPE     string `neo4j:"cpe" json:"cpe" desc:"The full CPE string representation." example:"cpe:2.3:a:apache:http_server:2.4.50:*:*:*:*:*:*:*" slim:"Technology"`
	Name    string `neo4j:"name" json:"name,omitempty" desc:"Optional common name for the technology." example:"Apache httpd" slim:"Technology"`
