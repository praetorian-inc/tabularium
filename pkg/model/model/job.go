...
type Job struct {
	...
	LOFileName    string            `dynamodbav:"largeOutputFileName" json:"largeOutputFileName,omitempty" desc:"The name of the file that contains the large output." example:"big_output.zip"`
