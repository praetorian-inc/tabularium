...
type Attribute struct {
	...
	Name         string            `neo4j:"name" json:"name" external:"true" desc:"Name of the attribute." example:"https"`
	Value        string            `neo4j:"value" json:"value" external:"true" desc:"Value of the attribute." example:"443"`
	Status       string            `neo4j:"status" json:"status" external:"true" desc:"Status of the attribute." example:"A"`
	...
	Capability   string            `neo4j:"capability" json:"capability,omitempty" external:"true" desc:"Capability that discovered this attribute." example:"portscan"`
	TTL          int64             `neo4j:"ttl" json:"ttl" desc:"Time-to-live for the attribute record (Unix timestamp)." example:"1706353200"`
	Metadata     map[string]string `neo4j:"metadata" json:"metadata,omitempty" external:"true" desc:"Additional metadata associated with the attribute." example:"{\"tool\": \"masscan\"}"`
