...
type ADObject struct {
	BaseAsset
	registry.ModelAlias
	Label           string   `neo4j:"label" json:"label" desc:"Primary label of the object." example:"ADUser" slim:"ADObject"`
	SecondaryLabels []string `neo4j:"-" json:"labels" desc:"Secondary labels of the object." example:"ADLocalGroup"`
	Domain          string   `neo4j:"domain" json:"domain" desc:"AD domain this object belongs to." example:"example.local" slim:"ADObject"`
	ObjectID        string   `neo4j:"objectid" json:"objectid" desc:"Object identifier." example:"S-1-5-21-123456789-123456789-123456789-1001" slim:"ADObject"`
...
type ADProperties struct {
	...
	TrustType                               string   `neo4j:"trusttype" json:"trusttype,omitempty" desc:"Type of AD trust relationship" example:"ParentChild"`
	...
	SubjectAltRequireDNS                    bool     `neo4j:"subjectaltrequiredns" json:"subjectaltrequiredns,omitempty" desc:"Certificate requires DNS name in Subject Alternative Name" example:"false"`
	SubjectAltRequireDomainDNS              bool     `neo4j:"subjectaltrequiredomaindns" json:"subjectaltrequiredomaindns,omitempty" desc:"Certificate requires domain DNS in Subject Alternative Name" example:"false"`
	SubjectAltRequireEmail                  bool     `neo4j:"subjectaltrequireemail" json:"subjectaltrequireemail,omitempty" desc:"Certificate requires email in Subject Alternative Name" example:"true"`
	SubjectAltRequireSPN                    bool     `neo4j:"subjectaltrequirespn" json:"subjectaltrequirespn,omitempty" desc:"Certificate requires SPN in Subject Alternative Name" example:"false"`
	SubjectRequireEmail                     bool     `neo4j:"subjectrequireemail" json:"subjectrequireemail,omitempty" desc:"Certificate requires email in subject" example:"false"`
	AuthorizedSignatures                    int      `neo4j:"authorizedsignatures" json:"authorizedsignatures,omitempty" desc:"Number of authorized signatures required" example:"1"`
	ApplicationPolicies                     []string `neo4j:"applicationpolicies" json:"applicationpolicies,omitempty" desc:"Application policy OIDs for certificates" example:"[\"1.3.6.1.5.5.7.3.2\"]"`
	IssuancePolicies                        []string `neo4j:"issuancepolicies" json:"issuancepolicies,omitempty" desc:"Certificate issuance policy OIDs" example:"[\"1.3.6.1.4.1.311.21.8.1\"]"`
	SchemaVersion                           int      `neo4j:"schemaversion" json:"schemaversion,omitempty" desc:"Certificate template schema version" example:"2"`
	RequiresManagerApproval                 bool     `neo4j:"requiresmanagerapproval" json:"requiresmanagerapproval,omitempty" desc:"Certificate enrollment requires manager approval" example:"true"`
	AuthenticationEnabled                   bool     `neo4j:"authenticationenabled" json:"authenticationenabled,omitempty" desc:"Authentication is enabled for the certificate template" example:"true"`
	SchannelAuthenticationEnabled           bool     `neo4j:"schannelauthenticationenabled" json:"schannelauthenticationenabled,omitempty" desc:"SChannel authentication is enabled" example:"false"`
	EnrolleeSuppliesSubject                 bool     `neo4j:"enrolleesuppliessubject" json:"enrolleesuppliessubject,omitempty" desc:"Enrollee can supply subject information in certificate request" example:"false"`
	CertificateApplicationPolicy            []string `neo4j:"certificateapplicationpolicy" json:"certificateapplicationpolicy,omitempty" desc:"Certificate application policy extensions" example:"[\"1.3.6.1.5.5.7.3.2\"]"`
	CertificateNameFlag                     string   `neo4j:"certificatenameflag" json:"certificatenameflag,omitempty" desc:"Certificate name flags configuration" example:"SubjectRequireDirectoryPath"`
	EffectiveEKUs                           []string `neo4j:"effectiveekus" json:"effectiveekus,omitempty" desc:"Effective Extended Key Usage OIDs after policy application" example:"[\"1.3.6.1.5.5.7.3.2\", \"1.3.6.1.5.5.7.3.4\"]"`
	EnrollmentFlag                          string   `neo4j:"enrollmentflag" json:"enrollmentflag,omitempty" desc:"Certificate enrollment flags" example:"AutoEnrollment"`
	Flags                                   string   `neo4j:"flags" json:"flags,omitempty" desc:"General purpose flags for the object" example:"0x00000001"`
	NoSecurityExtension                     bool     `neo4j:"nosecurityextension" json:"nosecurityextension,omitempty" desc:"Certificate template has no security extension" example:"false"`
	RenewalPeriod                           string   `neo4j:"renewalperiod" json:"renewalperiod,omitempty" desc:"Certificate renewal period" example:"6 weeks"`
	ValidityPeriod                          string   `neo4j:"validityperiod" json:"validityperiod,omitempty" desc:"Certificate validity period" example:"1 year"`
	OID                                     string   `neo4j:"oid" json:"oid,omitempty" desc:"Object identifier for the certificate template" example:"1.3.6.1.4.1.311.21.8.1234567.1234567.1.1.1"`
	HomeDirectory                           string   `neo4j:"homedirectory" json:"homedirectory,omitempty" desc:"User's home directory path" example:"\\\\fileserver\\users\\jsmith"`
	CertificatePolicy                       []string `neo4j:"certificatepolicy" json:"certificatepolicy,omitempty" desc:"Certificate policy OIDs" example:"[\"1.3.6.1.4.1.311.21.8.1\", \"1.3.6.1.5.5.7.2.1\"]"`
	CertTemplateOID                         string   `neo4j:"certtemplateoid" json:"certtemplateoid,omitempty" desc:"Certificate template object identifier" example:"1.3.6.1.4.1.311.21.8.1234567.1234567.1.1.1"`
	GroupLinkID                             string   `neo4j:"grouplinkid" json:"grouplinkid,omitempty" desc:"Link ID for group policy objects" example:"{31B2F340-016D-11D2-945F-00C04FB984F9}"`
	ObjectGUID                              string   `neo4j:"objectguid" json:"objectguid,omitempty" desc:"Globally unique identifier for the AD object" example:"a1b2c3d4-e5f6-7890-abcd-ef1234567890"`
	ExpirePasswordsOnSmartCardOnlyAccounts  bool     `neo4j:"expirepasswordsonsmartcardonlyaccounts" json:"expirepasswordsonsmartcardonlyaccounts,omitempty" desc:"Whether passwords expire for smart card only accounts" example:"false"`
	MachineAccountQuota                     int      `neo4j:"machineaccountquota" json:"machineaccountquota,omitempty" desc:"Number of computer accounts a user can create" example:"10"`
	SupportedKerberosEncryptionTypes        []string `neo4j:"supportedencryptiontypes" json:"supportedencryptiontypes,omitempty" desc:"Supported Kerberos encryption types" example:"[\"RC4_HMAC_MD5\", \"AES128_CTS_HMAC_SHA1_96\", \"AES256_CTS_HMAC_SHA1_96\"]"`
	TGTDelegation                           string   `neo4j:"tgtdelegation" json:"tgtdelegation,omitempty" desc:"TGT delegation configuration" example:"Enabled"`
	PasswordStoredUsingReversibleEncryption bool     `neo4j:"encryptedtextpwdallowed" json:"encryptedtextpwdallowed,omitempty" desc:"Password is stored using reversible encryption" example:"false"`
	SmartcardRequired                       bool     `neo4j:"smartcardrequired" json:"smartcardrequired,omitempty" desc:"Smart card is required for interactive logon" example:"false"`
	UseDESKeyOnly                           bool     `neo4j:"usedeskeyonly" json:"usedeskeyonly,omitempty" desc:"Use only DES encryption keys for Kerberos" example:"false"`
	LogonScriptEnabled                      bool     `neo4j:"logonscriptenabled" json:"logonscriptenabled,omitempty" desc:"Logon script is enabled for the account" example:"true"`
	LockedOut                               bool     `neo4j:"lockedout" json:"lockedout,omitempty" desc:"Account is currently locked out" example:"false"`
	UserCannotChangePassword                bool     `neo4j:"passwordcantchange" json:"passwordcantchange,omitempty" desc:"User cannot change their password" example:"false"`
	PasswordExpired                         bool     `neo4j:"passwordexpired" json:"passwordexpired,omitempty" desc:"Password has expired" example:"false"`
	DSHeuristics                            string   `neo4j:"dsheuristics" json:"dsheuristics,omitempty" desc:"Directory Service heuristics configuration" example:"0000000001"`
	UserAccountControl                      int      `neo4j:"useraccountcontrol" json:"useraccountcontrol,omitempty" desc:"User account control flags bitmask" example:"512"`
	TrustAttributesInbound                  string   `neo4j:"trustattributesinbound" json:"trustattributesinbound,omitempty" desc:"Inbound trust attributes" example:"0x00000020"`
	TrustAttributesOutbound                 string   `neo4j:"trustattributesoutbound" json:"trustattributesoutbound,omitempty" desc:"Outbound trust attributes" example:"0x00000020"`
	MinPwdLength                            int      `neo4j:"minpwdlength" json:"minpwdlength,omitempty" desc:"Minimum password length requirement" example:"8"`
	PwdProperties                           int      `neo4j:"pwdproperties" json:"pwdproperties,omitempty" desc:"Password policy properties bitmask" example:"1"`
	PwdHistoryLength                        int      `neo4j:"pwdhistorylength" json:"pwdhistorylength,omitempty" desc:"Number of passwords remembered in history" example:"24"`
	LockoutThreshold                        int      `neo4j:"lockoutthreshold" json:"lockoutthreshold,omitempty" desc:"Number of failed logon attempts before lockout" example:"5"`
	MinPwdAge                               string   `neo4j:"minpwdage" json:"minpwdage,omitempty" desc:"Minimum password age" example:"1d"`
	MaxPwdAge                               string   `neo4j:"maxpwdage" json:"maxpwdage,omitempty" desc:"Maximum password age" example:"90d"`
	LockoutDuration                         string   `neo4j:"lockoutduration" json:"lockoutduration,omitempty" desc:"Account lockout duration" example:"30m"`
	LockoutObservationWindow                int      `neo4j:"lockoutobservationwindow" json:"lockoutobservationwindow,omitempty" desc:"Time window in minutes for observing failed logon attempts" example:"30"`
	OwnerSid                                string   `neo4j:"ownersid" json:"ownersid,omitempty" desc:"Security identifier of the object owner" example:"S-1-5-21-3623811015-3361044348-30300820-1001"`
	SMBSigning                              bool     `neo4j:"smbsigning" json:"smbsigning,omitempty" desc:"SMB signing is required" example:"true"`
	WebClientRunning                        bool     `neo4j:"webclientrunning" json:"webclientrunning,omitempty" desc:"Whether WebDAV client service is running" example:"true"`
	RestrictOutboundNTLM                    bool     `neo4j:"restrictoutboundntlm" json:"restrictoutboundntlm,omitempty" desc:"Outbound NTLM authentication is restricted" example:"false"`
	GMSA                                    bool     `neo4j:"gmsa" json:"gmsa,omitempty" desc:"Group Managed Service Account" example:"true"`
	MSA                                     bool     `neo4j:"msa" json:"msa,omitempty" desc:"Managed Service Account" example:"false"`
	DoesAnyAceGrantOwnerRights              bool     `neo4j:"doesanyacegrantownerrights" json:"doesanyacegrantownerrights,omitempty" desc:"Whether any ACE grants owner rights" example:"true"`
	DoesAnyInheritedAceGrantOwnerRights     bool     `neo4j:"doesanyinheritedacegrantownerrights" json:"doesanyinheritedacegrantownerrights,omitempty" desc:"Whether any inherited ACE grants owner rights" example:"false"`
	ADCSWebEnrollmentHTTP                   string   `neo4j:"adcswebenrollmenthttp" json:"adcswebenrollmenthttp,omitempty" desc:"ADCS web enrollment HTTP endpoint availability" example:"http://ca.contoso.local/certsrv"`
	ADCSWebEnrollmentHTTPS                  string   `neo4j:"adcswebenrollmenthttps" json:"adcswebenrollmenthttps,omitempty" desc:"ADCS web enrollment HTTPS endpoint availability" example:"https://ca.contoso.local/certsrv"`
	ADCSWebEnrollmentHTTPSEPA               string   `neo4j:"adcswebenrollmenthttpsepa" json:"adcswebenrollmenthttpsepa,omitempty" desc:"ADCS web enrollment HTTPS with Extended Protection" example:"https://ca.contoso.local/certsrv"`
	LDAPSigning                             bool     `neo4j:"ldapsigning" json:"ldapsigning,omitempty" desc:"LDAP signing requirement" example:"Required"`
	LDAPAvailable                           bool     `neo4j:"ldapavailable" json:"ldapavailable,omitempty" desc:"Whether LDAP service is available" example:"true"`
	LDAPSAvailable                          bool     `neo4j:"ldapsavailable" json:"ldapsavailable,omitempty" desc:"Whether LDAPS (secure LDAP) is available" example:"true"`
	LDAPSEPA                                bool     `neo4j:"ldapsepa" json:"ldapsepa,omitempty" desc:"LDAPS with Extended Protection for Authentication" example:"Enabled"`
	IsDC                                    bool     `neo4j:"isdc" json:"isdc,omitempty" desc:"Whether computer is a Domain Controller" example:"true"`
	...
	Transitive                              string   `neo4j:"transitive" json:"transitive,omitempty" desc:"Whether trust relationship is transitive" example:"true"`
