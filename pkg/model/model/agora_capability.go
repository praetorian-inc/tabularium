...
type AgoraCapability struct {
	...
	LargeArtifact bool                  `json:"largeArtifact,omitempty" desc:"If true, this capability generates large output that can be stored and reviewed later" example:"false"`
}
