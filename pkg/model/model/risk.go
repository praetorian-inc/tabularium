...
type Risk struct {
	...
	// Attributes
	DNS        string `neo4j:"dns" json:"dns" desc:"Primary DNS or group associated with the risk." example:"example.com" slim:"Risk"`
	Name       string `neo4j:"name" json:"name" desc:"Name of the risk or vulnerability." example:"CVE-2023-12345" slim:"Risk"`
	Source     string `neo4j:"source" json:"source" desc:"Source that identified the risk." example:"nessus" slim:"Risk"`
	Status     string `neo4j:"status" json:"status" desc:"Current status of the risk (e.g., TH, OC, RM)." example:"TH" slim:"Risk"`
	...
	Target     Target `neo4j:"-" json:"-" slim:"Risk=target(Asset)"` // Internal use, not in schema
	History
	MLProperties
	Tags
	OriginationData
