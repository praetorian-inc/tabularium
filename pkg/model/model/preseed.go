...
type Preseed struct {
	...
	Type       string            `neo4j:"type" json:"type" desc:"Type of the preseed data." example:"whois" capmodel:"Preseed"`
	Title      string            `neo4j:"title" json:"title" desc:"Title or category within the preseed type." example:"registrant_email" capmodel:"Preseed"`
	Value      string            `neo4j:"value" json:"value" desc:"The actual preseed value." example:"test@example.com" capmodel:"Preseed"`
