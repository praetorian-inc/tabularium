...
type File struct {
	...
	Bytes     SmartBytes `dynamodbav:"-" json:"bytes" desc:"File content. Must be a JSON-compatible string. Can be encoded with base64 if it begins with the prefix 'base64:'" example:"base64:dGVzdA=="`
...
func (f *File) Hydrate() (string, func([]byte) error) {
	return f.Name, func(data []byte) error {
		f.Bytes = data
		return nil
	}
}
